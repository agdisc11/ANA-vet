...
import { useToxicologia } from '../../hooks/useDashboard';
...
export default function Toxicologia({ pesoKg }) {
  // Catálogo vía TanStack Query (cacheado 1 h; ver useToxicologia)
  const { data: toxinas = [], isLoading: cargando, isError } = useToxicologia();
  const errorApi = isError
    ? 'No se pudo cargar el catálogo de toxicología. Verifica que el servidor esté activo.'
    : null;
